...
public class Robot extends TimedRobot {
  ...
  /* Solenoid */
  private static DoubleSolenoid color_wheel = new DoubleSolenoid(1, PneumaticsModuleType.CTREPCM, 0, 1);
  private static DoubleSolenoid.Value color_wheel_value = DoubleSolenoid.Value.kReverse;
  private static long color_wheel_time;

  private static DoubleSolenoid ball_ramp = new DoubleSolenoid(2, PneumaticsModuleType.CTREPCM, 0, 1);
  private static DoubleSolenoid.Value ball_ramp_value = DoubleSolenoid.Value.kReverse;
  private static long ball_ramp_time;

  private static DoubleSolenoid trolley_lift = new DoubleSolenoid(2, PneumaticsModuleType.CTREPCM, 2, 3);
  ...
  private static DoubleSolenoid intake_arm = new DoubleSolenoid(2, PneumaticsModuleType.CTREPCM, 4, 5);
  private static DoubleSolenoid.Value intake_arm_value = DoubleSolenoid.Value.kReverse;
  private static long intake_arm_time;

  private static DoubleSolenoid robot_lift = new DoubleSolenoid(2, PneumaticsModuleType.CTREPCM, 6, 7);
